...
# Use a conservative connection pool to avoid exhausting Supabase's Session
# mode limits (pooler often caps clients around 20). Keep defaults low so two
# uvicorn workers don't overwhelm the pool. Allow overrides via env vars for
# local/dev usage.
